## Wait... <img width="75%" align="right" src="linkawho-logo.png"></img>
...
* [DuckDuckGo Lite](https://lite.duckduckgo.com) - DuckDuckGo but very lightweight. (NOTE: Great for slow connections!)
...
* [Bluesky](https://bsky.app) - The true white-tent social network. (NOTE: Somewhat liberal, and has the users to match.)

## NSFW (Porn)

* [PornHub](https://pornhub.com) - The classic porn website. (NOTE: Unstable with NextDNS bypass sometimes.)
* [YouPorn](https://youporn.com) - Owned by the same people as PornHub. (NOTE: Stable with NextDNS bypass.)
* [Rule34.xxx](https://rule34.xxx) - Porn of cartoon characters, anime characters, video game characters, and  original characters. (NOTE: Does NOT require bypass in some areas.)
